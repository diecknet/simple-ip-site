  ...
  <body class="w3-light-grey w3-monospace w3-animate-left">
    <div class="w3-content">
      ...
      <section class="bg-mainsection w3-container w3-card w3-padding-16">
        ...
        <script>
          ...
          document.getElementById("tip").innerHTML =
            '💡 <i class="w3-medium tip">Tip: Click on <span class="w3-medium" onclick="copy2Clipboard(\'ipaddress\');">IP-Address</span> to copy the value into the clipboard.</i>';
          //-->
        </script>
      </section>
      <footer
      ...
      >
        ...
        >
        <a href="https://diecknet.de/de/legal/" class="w3-bar-item w3-button w3-right">Imprint / Impressum</a>
